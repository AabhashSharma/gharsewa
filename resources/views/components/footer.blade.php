<footer id="contact" class="bg-gray-800 text-white py-16">
    <div class="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-12 md:gap-0">
      <div>
        ...
        <p class="text-sm mt-4 max-w-sm leading-relaxed">
          Simplifying property care across Nepal with verified professionals and smart digital tools.
        </p>
      </div>
      <div>
    ...
    <div class="text-center mt-10 text-sm text-gray-400">&copy; 2025 GharSewa. All rights reserved.</div>
</footer>